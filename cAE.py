...
x = layers.Conv2DTranspose(15, (3, 3), strides=2, activation="relu", padding="same")(x)
x = layers.Conv2DTranspose(30, (4, 4), strides=2, activation="relu", padding="same")(x)
x = layers.Conv2DTranspose(40, (5, 5), strides=2, activation="relu", padding="same")(x)
x = layers.Conv2DTranspose(50, (7, 7), strides=2, activation="relu", padding="same")(x)
